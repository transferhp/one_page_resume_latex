...
\begin{itemize}[leftmargin=0.15in, itemsep=1pt]
    ...
    \item Refactored a segmentation model code using Ray and orchestrated pipeline through composer on GCP for a retail client, reducing the operation time by 3x.
    \item Led technical solution design, built prototype and deployed ML applications at scale.
\end{itemize}
